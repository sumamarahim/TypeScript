// Calculator
// Sum, Div, Sub, Mul WITHOUT modules
...
if (userOpt.opt == 1) {
  ...
  let sumShow = console.log(
    chalk.bgYellow(`| Sum of ${takeNum.num1} and ${takeNum.num2} is: ${sum} |`)
  );
  ...
  let subShow = console.log(
    chalk.bgMagenta(
      `| Sub of ${takeNum.num2} from ${takeNum.num1} is: ${sub} |`
    )
  );
  ...
  let divShow = console.log(
    chalk.bgBlue(`| Div of ${takeNum.num1} and ${takeNum.num2} is: ${div} |`)
  );
  ...
  let mulShow = console.log(
    chalk.bgGreen(`| Mul of ${takeNum.num1} and ${takeNum.num2} is: ${mul} |`)
  );
